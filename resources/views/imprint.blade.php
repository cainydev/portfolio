...
<x-layout>
    ...
    <x-content>
        ...
        <p>
            ...
            Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: <strong>DE352723704</strong><br>
        </p>
    ...
    <x-contact>
        <h2 class="text-4xl font-semibold text-center">
            Weitere <x-underline w="1">Fragen?</x-underline>
        </h2>
