<div>
    ...
    <x-headline subtitle="Angaben gemäß § 5 TMG">Impressum</x-headline>
    <x-content>
        <address>
            techbra.in Webdesign<br>
        ...
        <section>
            ...
            <p>
                Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: <strong>DE352723704</strong>
            </p>
        </section>
        <section>
        ...
        <section>
            ...
            <p>
                ...
                zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen. Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen nach den allgemeinen Gesetzen bleiben hiervon unberührt. Eine diesbezügliche Haftung ist jedoch erst
            ...
            <h4 class="scroll-mt-8" id="datenschutz">Datenschutz</h4>
            <p>
    ...
    <x-contact>
        <h2 class="text-4xl font-semibold text-center">
            Weitere
            <x-underline w="1">Fragen?</x-underline>
        </h2>
        <p class="mt-3 text-lg">Schreiben Sie uns gerne eine Nachricht im nachfolgenden Formular.</p>
    </x-contact>
