<div>
    ...
    <x-portfolio-entry title="KIS - Internes Informationssystem"
                       ...
                       year="2022"
                       :alternate="false">
        <img class="object-cover border-primary border-2 lg:col-span-3 rounded-lg"
             src="{{ Vite::asset('resources/images/portfolio/kis_calc.webp') }}"
             alt="KIS Berechnungstool"
             width="380" height="180">
        <img class="object-cover border-primary border-2 lg:col-span-2 rounded-lg"
