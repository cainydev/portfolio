<div>
    ...
    <x-hero
        subtitle="Professionelles Webdesign für stabile und langfristig erfolgreiche Seiten. Finden Sie jetzt das richtige Angebot."
        cta_text="Zum Angebot"
        href="#service-anker"
        img="illustrations.static_website">
        Das
        <x-underline>Komplettpaket</x-underline>
        für ihre Website!
    </x-hero>
    <x-service/>
    <x-techstack/>
