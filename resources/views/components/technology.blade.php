...
<div class="relative flex p-4 pr-24 mr-12 text-white bg-primary group">
    ...
    <a href="https://{{ $url }}"
       target="_blank"
       class="absolute transition-all duration-500 translate-x-1/2 -translate-y-1/2 group-hover:right-1/2 right-2 top-1/2">
        <img src="{{ $img }}"
             class="w-24 h-24 p-4 bg-white border-4 border-primary"
             alt="Laravel Logo">
        <p
