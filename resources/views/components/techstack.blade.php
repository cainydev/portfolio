<x-section>
    <x-two-col-layout>
        <div class="flex flex-col items-start">
            <h2 class="text-4xl">
                <x-underline w="1">Womit</x-underline> arbeiten wir?
            </h2>
            ...
            <p class="mt-3">Zusätzlich zu Laravel verwendet wir in den meisten Fällen TailwindCSS für das Styling sowie
                AlpineJS für die
                Interaktivität.</p>
            <p class="mt-3">Bei CMS oder Onlineshops verwenden wir zusätzlich das auf Laravel basieremde Statamic CMS.
            </p>
            <p class="my-6">Falls Sie Fragen zu den abgebildeten Technologien und deren Möglichkeiten haben freuen wir
                uns
                über Ihren Kontakt:</p>
